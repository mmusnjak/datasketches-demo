...
public class Quantiles {
  ...
  void quantilesExample() {
    ...
    IntStream.range(50_000_000, 100_000_000).forEach(sketch1::update);
    ...
    IntStream.range(100_000_000, 150_000_000).forEach(sketch1::update);
    ...
    IntStream.range(150_000_000, 200_000_000).forEach(sketch1::update);
    ...
    assertEquals(100_000_000.0, median, 600_000.0);
  }
}
